...
import AddCategoery from "../Pages/Category/AddCategory.jsx";
import EditCategoery from "../Pages/Category/EditCategory.jsx";
import Slot from "../Pages/Slots/Slot.jsx";
import AllCustomers from "../Pages/Customer/Customer.jsx";
import GetAllpartners from "../Pages/VerifyPartner/GetAllpartners.jsx";
import Booking from "../Pages/Booking/Booking.jsx";
import Promocodes from "../Pages/Promocodes/GetPromocodes.jsx";
import SlotDiscount from "../Pages/SlotDiscount/SlotDiscount.jsx";
import AddSlot from "../Pages/Slots/AddSlot.jsx";
import EditSlot from "../Pages/Slots/EditSlot.jsx";
import AddSlotDiscount from "../Pages/SlotDiscount/addSlotDiscount.jsx";
import EditSlotDiscount from "../Pages/SlotDiscount/editSlotDiscount.jsx";
import AddPromoCodes from "../Pages/Promocodes/AddPromocodes.jsx";
import EditPromoCodes from "../Pages/Promocodes/EditPromocodes.jsx";
import GetpartnersDocuments from "../Pages/VerifyPartner/PartnerDocuments.jsx";
...
import GetReleventpartners from "../Pages/Booking/GetRelevantPartners.jsx";
...
const authProtectedRoutes = [
  ...
  {path:"/addcategory", component:<AddCategoery />},
  {path:"/editcategory/:id", component:<EditCategoery />},
  {path:"/slots", component:<Slot />},
  {path:"/slot-discount", component:<SlotDiscount />},
  {path:"/customer", component:<AllCustomers />},
  {path:"/partners", component:<GetAllpartners />},
  {path:"/bookings", component:<Booking />},
  {path:"/promo-codes", component:<Promocodes />},
{ path:'/addslot', component : <AddSlot/>},
{ path:'/editslot/:id' ,component : <EditSlot/>},
 {path:'/slot-discount', component: <SlotDiscount/>},
 {path:'/addslot/discount' ,component:  <AddSlotDiscount />},
 {path:'/editslot/discount/:id', component:  <EditSlotDiscount />},

 {path:'/partners' ,component:  <GetAllpartners/>},
 {path:'/customers' ,component:  <AllCustomers/>},

 {path:'/partner-documents/:id' ,component:  <GetpartnersDocuments/>},
 {path:'/promo-codes' ,component:  <Promocodes/>},
 {path:'/add-promocodes' ,component:  <AddPromoCodes/>},
 {path:'/edit-promocodes/:id' ,component:  <EditPromoCodes/>},
  {path:'/service/:id'  ,component:<Service/>},
  {path:'/addservice/:id' ,component:<AddService/>},
  {path : '/editservice/:id/:id1' ,component:<EditService/>},
  {path:'/bookings' ,component:<Booking/>},
  {path:'/get-relevant-providers/:id' ,component:<GetReleventpartners/>},
